...
const en = {
  ...
  attributes: {
    ...
    '#travel-santa-monica img': { alt: 'A seabird crossing the sunset at Santa Monica Beach' },
    '#travel-tongren img': { alt: 'Water terraces and paths surrounded by greenery in Tongren' },
  ...
  copy: {
    ...
    '#photography-hero .detail-deck': 'A small sequence of architectural and night studies.',
    ...
    '#travel-hero .detail-eyebrow': 'Place notes',
    '#travel-hero .detail-deck': 'Two concise records of water, light, and place.',
    '#travel-notes h2': 'Place notes',
    '#travel-notes .travel-intro': 'Short visual notes from places I have visited.',
    '#travel-santa-monica .detail-meta': 'Santa Monica, California',
    '#travel-santa-monica h2': 'Sunset by the Pacific',
    '#travel-santa-monica figcaption': 'Santa Monica · Sunset',
    '#travel-tongren .detail-meta': 'Tongren, Guizhou',
    '#travel-tongren h2': 'Water and paths',
    '#travel-tongren figcaption': 'Tongren · Water and paths',
...
const zh = {
  ...
  attributes: {
    ...
    '#travel-santa-monica img': { alt: '圣莫尼卡海滩日落中飞过的海鸟' },
    '#travel-tongren img': { alt: '铜仁绿意环绕的水景台地与步道' },
  ...
  copy: {
    ...
    '#photography-hero .detail-deck': '一组简洁的建筑与夜景观察。',
    ...
    '#travel-hero h1': '旅行',
    '#travel-hero .detail-eyebrow': '地点随记',
    '#travel-hero .detail-deck': '两则关于水、光线与地点的简短记录。',
    '#travel-notes h2': '地点随记',
    '#travel-notes .travel-intro': '来自我到访地点的简短影像记录。',
    '#travel-santa-monica .detail-meta': '美国加利福尼亚州圣莫尼卡',
    '#travel-santa-monica h2': '太平洋边的日落',
    '#travel-santa-monica figcaption': '圣莫尼卡 · 日落',
    '#travel-tongren .detail-meta': '贵州铜仁',
    '#travel-tongren h2': '水与步道',
    '#travel-tongren figcaption': '铜仁 · 水与步道',
