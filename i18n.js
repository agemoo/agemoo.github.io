...
const en = {
  ...
  copy: {
    ...
    '#about .capability-row:nth-child(4) h3': 'Reporting &amp; Workflow',
    ...
    '#projects .project-row:nth-child(1) .project-evidence': '<strong>Evidence:</strong> 19,000 campaign impressions · 8,000+ audience reach per event.',
    ...
    '#projects .project-row:nth-child(2) .project-evidence': '<strong>Evidence:</strong> 525+ promotional article reads · reposted by Wuhan Cultural Tourism Group’s official account.',
    '#edu .stitle': 'Education',
    '#edu .edu-entry:nth-child(1) .edu-school': 'Southern Utah University',
    '#edu .edu-entry:nth-child(1) .edu-dates': 'Aug 2025 — May 2027 (Expected)',
    ...
    '#edu .edu-entry:nth-child(1) .edu-focus': 'Focus: Social media strategy, content creation, brand strategy, and analytical coursework.',
    '#edu .edu-entry:nth-child(2) .edu-school': 'Wuhan Polytechnic University',
    '#edu .edu-entry:nth-child(2) .edu-dates': 'Sep 2023 — Jun 2025',
    '#edu .edu-entry:nth-child(2) .edu-degree': 'B.A. in Advertising (Transferred)',
    '#edu .edu-entry:nth-child(2) .edu-secondary': 'School of Humanities &amp; Media',
    '#edu .edu-entry:nth-child(2) .edu-focus': 'Focus: Brand planning, consumer behavior, media evaluation, and organizational communication.',
    '#campus-music .stitle': 'Campus &amp; Music',
    '#campus-music .life-row:nth-child(1) h3': 'Jazz Performance',
    '#campus-music .life-row:nth-child(1) p': 'Electric bassist in Southern Utah University big band and combo settings.',
    '#campus-music .life-row:nth-child(2) h3': 'Campus Communication',
    '#campus-music .life-row:nth-child(2) p': 'Student-facing event promotion and performance content across campus settings.',
    '#visual-work .stitle': 'Visual Work',
    '#visual-work .section-intro': 'A concise selection of product, event, print, and photographic work, with the full archive available below.',
...
const zh = {
  ...
  copy: {
    ...
    '#about .capability-row:nth-child(4) h3': '报告与工作流',
    ...
    '#projects .project-row:nth-child(1) .project-evidence': '<strong>证据：</strong>19,000 次活动传播展示 · 单场活动触达 8,000+ 人。',
    ...
    '#projects .project-row:nth-child(2) .project-evidence': '<strong>证据：</strong>活动推广文章阅读 525+ · 武汉文旅集团官方账号转载。',
    '#edu .stitle': '教育经历',
    '#edu .edu-entry:nth-child(1) .edu-school': '南犹他州立大学',
    '#edu .edu-entry:nth-child(1) .edu-dates': '2025.08 — 2027.05（预计）',
    '#edu .edu-entry:nth-child(1) .edu-degree': '战略传播理学学士（在读）',
    '#edu .edu-entry:nth-child(1) .edu-secondary': '辅修 · 商业分析',
    '#edu .edu-entry:nth-child(1) .edu-focus': '方向：社媒策略、内容创作、品牌策略与分析类课程。',
    '#edu .edu-entry:nth-child(2) .edu-school': '武汉轻工大学',
    '#edu .edu-entry:nth-child(2) .edu-dates': '2023.09 — 2025.06',
    '#edu .edu-entry:nth-child(2) .edu-degree': '广告学文学学士（后转学）',
    '#edu .edu-entry:nth-child(2) .edu-secondary': '人文与传媒学院',
    '#edu .edu-entry:nth-child(2) .edu-focus': '方向：品牌策划、消费者行为、媒介投放评估与组织传播。',
    '#campus-music .stitle': '校园与音乐',
    '#campus-music .life-row:nth-child(1) h3': '爵士演奏',
    '#campus-music .life-row:nth-child(1) p': '在 Southern Utah University 大乐队与小型爵士组合中担任电贝斯手。',
    '#campus-music .life-row:nth-child(2) h3': '校园传播',
    '#campus-music .life-row:nth-child(2) p': '面向学生受众，参与校园活动推广与演出内容制作。',
    '#visual-work .stitle': '视觉作品',
    '#visual-work .section-intro': '精选产品、活动、印刷与摄影作品，其余内容收纳在下方完整归档中。',
