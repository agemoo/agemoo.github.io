...
const en = {
  ...
  attributes: {
    ...
    '#outside-music .music-lead img': { alt: 'Mukun Sun performing upright bass at SUU Jazz Fest' },
    '#music-artist-finalist img': { alt: 'Mukun Sun with the band for the SUU International Student Artist performance' },
    '#music-grand-ball img': { alt: 'Mukun Sun playing upright bass with the Grand Ball jazz ensemble' },
  ...
  copy: {
    ...
    '#outside-music .music-intro-copy': 'I play upright and electric bass, but much of my music work also happens before the stage: arranging, organizing rehearsals, coordinating venues, and building an event around a band.',
    '#outside-music .music-lead figcaption': 'SUU Jazz Fest · February 21, 2026',
    '#outside-music .music-history-label--performances': 'Selected performances &amp; projects',
    '#music-artist-finalist .music-entry-meta': '<time datetime="2026-04-14">Apr 14, 2026</time><span>Cedar City, Utah</span>',
    '#music-artist-finalist h3': 'Finalist · SUU International Student Artist',
    '#music-artist-finalist .music-entry-description': 'Named a finalist, then organized rehearsals and coordinated the band for a performance at the SUU Alumni Center. Upright bass.',
    '#music-artist-finalist figcaption': 'After the Alumni Center performance',
    '#music-student-center .music-entry-meta': '<time datetime="2026-03-31">Mar 31, 2026</time><span>Cedar City, Utah</span>',
    '#music-student-center h3': 'SUU Jazz Big Band',
    '#music-student-center p': 'Performed on upright bass with the Jazz Big Band at the SUU Student Center.',
    '#music-grand-ball .music-entry-meta': '<time datetime="2026-03-28">Mar 28, 2026</time><span>Hildale, Utah</span>',
    '#music-grand-ball h3': 'Grand Ball',
    '#music-grand-ball .music-entry-description': 'Invited to play upright bass with the jazz ensemble accompanying the Grand Ball.',
    '#music-grand-ball figcaption': 'Grand Ball · Hildale, Utah',
    '#music-tbird .music-entry-meta': '<time datetime="2026-02">Feb–Mar 2026</time><span>Cedar City, Utah</span>',
    '#music-tbird h3': 'T-Bird Marching Band',
    ...
    '#music-jazz-fest .music-entry-meta': '<time datetime="2026-02-21">Feb 21, 2026</time><span>Cedar City, Utah</span>',
    '#music-jazz-fest h3': 'SUU Jazz Fest',
    ...
    '#music-campus-concert .music-entry-meta': '<time datetime="2024-11-16">Nov 16, 2024</time><span>Wuhan, China</span>',
    '#music-campus-concert h3': 'Independent Jazz Concert',
    '#music-campus-concert .music-entry-description': 'Produced a jazz concert at a campus café from start to finish: secured the venue, arranged music, organized rehearsals, designed and promoted the event, and led on-site execution.',
    '#music-campus-concert figcaption': 'Campus café jazz concert',
    '#music-welcome-gala .music-entry-meta': '<time datetime="2024-09-15">Sep 15, 2024</time><span>Wuhan, China</span>',
    '#music-welcome-gala h3': 'Freshmen Welcome Gala',
    '#music-welcome-gala .music-entry-description': 'While serving as one of the gala’s promotion leads, I also assembled the band, organized rehearsals, and performed on stage.',
    '#music-welcome-gala figcaption': 'Freshmen Welcome Gala · Wuhan Polytechnic University',
    '#music-ni-jazz-bar .music-entry-meta': '<time datetime="2024-03-25">Mar 25, 2024</time><span>Wuhan, China</span>',
    '#music-ni-jazz-bar h3': 'NI Jazz Bar Jam Session',
    '#music-ni-jazz-bar p': 'Joined the jam session as a bassist.',
    '#music-fashion-show .music-entry-meta': '<time datetime="2023-12-04">Dec 4, 2023</time><span>Wuhan, China</span>',
    '#music-fashion-show h3': 'Environmental Fashion Design Competition',
    ...
    '#outside-music .music-history-label--study': 'Study',
    '#music-study-sun time': 'Sep 2025',
    '#music-study-sun p': 'Studied with SUU professor Sun Xun.',
...
const zh = {
  ...
  attributes: {
    ...
    '#outside-music .music-lead img': { alt: '孙慕坤在 SUU Jazz Fest 舞台上演奏低音提琴' },
    '#music-artist-finalist img': { alt: '孙慕坤与 SUU International Student Artist 演出的乐队成员' },
    '#music-grand-ball img': { alt: '孙慕坤在 Grand Ball 爵士乐队中演奏低音提琴' },
  ...
  copy: {
    ...
    '#outside-music h2': '音乐',
    '#outside-music .music-intro-copy': '我演奏低音提琴和电贝斯，但很多音乐工作发生在登台之前：编曲、组织排练、协调场地，以及围绕一支乐队完成整场活动。',
    '#outside-music .music-lead figcaption': 'SUU Jazz Fest · 2026 年 2 月 21 日',
    '#outside-music .music-history-label--performances': '演出与项目精选',
    '#music-artist-finalist .music-entry-meta': '<time datetime="2026-04-14">2026 年 4 月 14 日</time><span>美国犹他州锡达城</span>',
    '#music-artist-finalist h3': 'SUU International Student Artist · Finalist',
    '#music-artist-finalist .music-entry-description': '入选 Finalist 后，组织排练并协调乐队，在 SUU Alumni Center 完成演出，演奏低音提琴。',
    '#music-artist-finalist figcaption': 'Alumni Center 演出结束后',
    '#music-student-center .music-entry-meta': '<time datetime="2026-03-31">2026 年 3 月 31 日</time><span>美国犹他州锡达城</span>',
    '#music-student-center h3': 'SUU 爵士大乐队',
    '#music-student-center p': '随爵士大乐队在 SUU Student Center 演出，演奏低音提琴。',
    '#music-grand-ball .music-entry-meta': '<time datetime="2026-03-28">2026 年 3 月 28 日</time><span>美国犹他州 Hildale</span>',
    '#music-grand-ball h3': 'Grand Ball',
    '#music-grand-ball .music-entry-description': '受邀加入 Grand Ball 的爵士伴奏乐队，演奏低音提琴。',
    '#music-grand-ball figcaption': 'Grand Ball · 美国犹他州 Hildale',
    '#music-tbird .music-entry-meta': '<time datetime="2026-02">2026 年 2–3 月</time><span>美国犹他州锡达城</span>',
    '#music-tbird h3': 'T-Bird Marching Band',
    '#music-tbird p': '作为替补电贝斯手加入，并在 SUU 体育馆的篮球比赛中随助威乐队演出。',
    '#music-jazz-fest .music-entry-meta': '<time datetime="2026-02-21">2026 年 2 月 21 日</time><span>美国犹他州锡达城</span>',
    '#music-jazz-fest h3': 'SUU Jazz Fest',
    '#music-jazz-fest p': '随 SUU 爵士大乐队在 Heritage Center 演出，演奏低音提琴。',
    '#music-jazz-fest .music-watch': '观看演出 ↗',
    '#music-campus-concert .music-entry-meta': '<time datetime="2024-11-16">2024 年 11 月 16 日</time><span>中国武汉</span>',
    '#music-campus-concert h3': '自主爵士音乐会',
    '#music-campus-concert .music-entry-description': '在校内咖啡馆从零组织一场爵士音乐会：对接场地、完成乐队编曲与排练组织、设计并宣传活动，以及负责现场执行。',
    '#music-campus-concert figcaption': '校内咖啡馆爵士音乐会',
    '#music-welcome-gala .music-entry-meta': '<time datetime="2024-09-15">2024 年 9 月 15 日</time><span>中国武汉</span>',
    '#music-welcome-gala h3': '迎新晚会',
    '#music-welcome-gala .music-entry-description': '在担任晚会宣发负责人之一的同时，组建乐队、组织排练并登台演出。',
    '#music-welcome-gala figcaption': '武汉轻工大学迎新晚会',
    '#music-ni-jazz-bar .music-entry-meta': '<time datetime="2024-03-25">2024 年 3 月 25 日</time><span>中国武汉</span>',
    '#music-ni-jazz-bar h3': 'NI Jazz Bar Jam Session',
    '#music-ni-jazz-bar p': '作为贝斯手参加 Jam Session。',
    '#music-fashion-show .music-entry-meta': '<time datetime="2023-12-04">2023 年 12 月 4 日</time><span>中国武汉</span>',
    '#music-fashion-show h3': '环保服装设计大赛',
    '#music-fashion-show p': '为暖场节目重新编排《Just the Two of Us》，组织排练，并设计宣传海报。',
    '#outside-music .music-history-label--study': '学习经历',
    '#music-study-sun time': '2025 年 9 月',
    '#music-study-sun p': '师从 SUU 教授孙逊老师。',
