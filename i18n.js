...
const en = {
  ...
  copy: {
    ...
    '#nav .links': '<a href="#about">About</a><a href="#experience">Experience</a><a href="#projects">Projects</a><a href="#edu">Education</a><a href="#campus-music">Music</a><a href="#visual-work">Visual Work</a><a href="#contact">Contact</a>',
    '#nav .compact-nav summary': 'Sections',
    '#nav .compact-links': '<a href="#about">About</a><a href="#experience">Experience</a><a href="#projects">Projects</a><a href="#edu">Education</a><a href="#campus-music">Music</a><a href="#visual-work">Visual Work</a><a href="#contact">Contact</a>',
    '.hero h1': 'Mukun Sun',
...
const zh = {
  ...
  copy: {
    ...
    '#nav .links': '<a href="#about">关于</a><a href="#experience">工作经历</a><a href="#projects">项目</a><a href="#edu">教育</a><a href="#campus-music">音乐</a><a href="#visual-work">视觉作品</a><a href="#contact">联系</a>',
    '#nav .compact-nav summary': '章节',
    '#nav .compact-links': '<a href="#about">关于</a><a href="#experience">工作经历</a><a href="#projects">项目</a><a href="#edu">教育</a><a href="#campus-music">音乐</a><a href="#visual-work">视觉作品</a><a href="#contact">联系</a>',
    '.hero h1': '孙慕坤',
