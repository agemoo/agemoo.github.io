...
const en = {
  ...
  attributes: {
    ...
    '#visual-gallery .detail-media:nth-child(6) img': { alt: 'Laoshan folk-arts trifold brochure exterior' },
    '#visual-gallery .detail-media:nth-child(7) img': { alt: 'Laoshan folk-arts trifold brochure interior' },
    '#visual-gallery .detail-media:nth-child(8) img': { alt: 'Winter Jazz Concert key visual poster designed for a hotel jazz event' },
    '#visual-gallery .detail-media:nth-child(9) img': { alt: 'International Museum Day banner for Wuhan Museum' },
  ...
  copy: {
    ...
    '#visual-gallery .detail-media:nth-child(6) figcaption': 'Laoshan Folk Arts · Trifold Exterior',
    '#visual-gallery .detail-media:nth-child(7) figcaption': 'Laoshan Folk Arts · Trifold Interior',
    '#visual-gallery .detail-media:nth-child(8) figcaption': 'Winter Jazz Concert · Hotel Event Visual',
    '#visual-gallery .detail-media:nth-child(9) figcaption': 'International Museum Day · Wuhan Museum',
...
const zh = {
  ...
  attributes: {
    ...
    '#visual-gallery .detail-media:nth-child(6) img': { alt: '崂山民艺文化三折页外页' },
    '#visual-gallery .detail-media:nth-child(7) img': { alt: '崂山民艺文化三折页内页' },
    '#visual-gallery .detail-media:nth-child(8) img': { alt: '为酒店爵士演出设计的冬日爵士主视觉海报' },
    '#visual-gallery .detail-media:nth-child(9) img': { alt: '武汉博物馆国际博物馆日活动 Banner' },
  ...
  copy: {
    ...
    '#visual-gallery .detail-media:nth-child(6) figcaption': '崂山民艺 · 三折页外页',
    '#visual-gallery .detail-media:nth-child(7) figcaption': '崂山民艺 · 三折页内页',
    '#visual-gallery .detail-media:nth-child(8) figcaption': '冬日爵士音乐会 · 酒店活动视觉',
    '#visual-gallery .detail-media:nth-child(9) figcaption': '国际博物馆日 · 武汉博物馆',
