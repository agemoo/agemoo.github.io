...
const en = {
  ...
  attributes: {
    ...
    '#music-fashion-show .detail-media:nth-child(1) img': { alt: 'The band performing at the Environmental Fashion Design Competition' },
    '#music-fashion-show .detail-media:nth-child(2) img': { alt: 'Mukun Sun playing electric bass during the warm-up performance' },
    '#music-study-sun img': { alt: 'Mukun Sun with SUU professor Sun Xun' },
  ...
  copy: {
    ...
    '#music-fashion-show .detail-media:nth-child(1) figcaption': 'Warm-up performance · Wuhan',
    '#music-fashion-show .detail-media:nth-child(2) figcaption': '“Just the Two of Us” arrangement',
    ...
    '#photography-gallery .detail-media:nth-child(6) figcaption': 'Boats on blue water',
...
const zh = {
  ...
  attributes: {
    ...
    '#music-fashion-show .detail-media:nth-child(1) img': { alt: '乐队在环保服装设计大赛上演出' },
    '#music-fashion-show .detail-media:nth-child(2) img': { alt: '孙慕坤在暖场演出中演奏电贝斯' },
  ...
  copy: {
    ...
    '#music-fashion-show .detail-media:nth-child(1) figcaption': '暖场演出 · 武汉',
    '#music-fashion-show .detail-media:nth-child(2) figcaption': '《Just the Two of Us》改编',
    '#music-study h2': '学习经历',
    ...
    '#photography-gallery .detail-media:nth-child(6) figcaption': '蓝色水面上的船',
