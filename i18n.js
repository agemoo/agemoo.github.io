...
const en = {
  ...
  attributes: {
    ...
    '#visual-archive .detail-media:nth-child(9) img': { alt: 'Night photograph of a white bass guitar against a tree' },
    '#visual-archive .detail-media:nth-child(10) img': { alt: 'Bass guitar atmosphere photography, study two' },
    '#visual-archive .detail-media:nth-child(11) img': { alt: 'Bass guitar atmosphere photography, study three' },
    ...
    '#outside-photography .detail-media:nth-child(1) img': { alt: 'Night photograph of a white bass guitar against a tree' },
    '#outside-photography .detail-media:nth-child(2) img': { alt: 'Bass guitar atmosphere photography, study two' },
    '#outside-photography .detail-media:nth-child(3) img': { alt: 'Bass guitar atmosphere photography, study three' },
  ...
  copy: {
    ...
    '#visual-archive .detail-media:nth-child(9) figcaption': 'Bass · Night Study',
    '#visual-archive .detail-media:nth-child(10) figcaption': 'Bass · Study 02',
    '#visual-archive .detail-media:nth-child(11) figcaption': 'Bass · Study 03',
    ...
    '#outside-nav .links': '<a href="#outside-music">Music</a><a href="#outside-photography">Photography</a><a href="#outside-places">Places</a>',
    '#outside-nav .compact-nav summary': 'Sections',
    '#outside-nav .compact-links': '<a href="#outside-music">Music</a><a href="#outside-photography">Photography</a><a href="#outside-places">Places</a><a href="index.html#outside-work">Portfolio index</a>',
    '#outside-nav .back-link': '← Portfolio index',
    '#outside-hero h1': 'Outside Work',
    '#outside-hero .detail-eyebrow': 'Music · Photography · Places',
    ...
    '#outside-photography .detail-media:nth-child(1) figcaption': 'Bass · Night Study',
    '#outside-photography .detail-media:nth-child(2) figcaption': 'Bass · Study 02',
    '#outside-photography .detail-media:nth-child(3) figcaption': 'Bass · Study 03',
    '#outside-places h2': 'Places',
    '#outside-places p': 'Travel and museums are another way I pay attention to place, design, and atmosphere. This section will grow through original photographs and short notes rather than travel-guide summaries.',
...
const zh = {
  ...
  attributes: {
    ...
    '#visual-archive .detail-media:nth-child(9) img': { alt: '白色贝斯倚靠树干的夜色氛围摄影' },
    '#visual-archive .detail-media:nth-child(10) img': { alt: '贝斯氛围摄影系列之二' },
    '#visual-archive .detail-media:nth-child(11) img': { alt: '贝斯氛围摄影系列之三' },
    ...
    '#outside-photography .detail-media:nth-child(1) img': { alt: '白色贝斯倚靠树干的夜色摄影' },
    '#outside-photography .detail-media:nth-child(2) img': { alt: '贝斯氛围摄影系列之二' },
    '#outside-photography .detail-media:nth-child(3) img': { alt: '贝斯氛围摄影系列之三' },
  ...
  copy: {
    ...
    '#visual-archive .detail-media:nth-child(9) figcaption': '贝斯 · 夜色习作',
    '#visual-archive .detail-media:nth-child(10) figcaption': '贝斯 · 习作 02',
    '#visual-archive .detail-media:nth-child(11) figcaption': '贝斯 · 习作 03',
    '#visual-footer span': '孙慕坤 · 视觉作品精选',
    '#visual-footer a': '返回项目列表',
    '#outside-nav .brand': '孙慕坤 · 工作之外',
    '#outside-nav .links': '<a href="#outside-music">音乐</a><a href="#outside-photography">摄影</a><a href="#outside-places">地方</a>',
    '#outside-nav .compact-nav summary': '章节',
    '#outside-nav .compact-links': '<a href="#outside-music">音乐</a><a href="#outside-photography">摄影</a><a href="#outside-places">地方</a><a href="index.html#outside-work">返回作品集</a>',
    '#outside-nav .back-link': '← 返回作品集',
    '#outside-hero h1': '工作之外',
    '#outside-hero .detail-eyebrow': '音乐 · 摄影 · 地方',
    ...
    '#outside-photography .detail-media:nth-child(1) figcaption': '贝斯 · 夜色习作',
    '#outside-photography .detail-media:nth-child(2) figcaption': '贝斯 · 习作 02',
    '#outside-photography .detail-media:nth-child(3) figcaption': '贝斯 · 习作 03',
    '#outside-places h2': '地方',
    '#outside-places p': '旅行与博物馆让我继续观察地方、设计与氛围。这里会逐步加入原创照片与短记，而不是旅行攻略式的汇总。',
