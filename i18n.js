...
const en = {
  ...
  attributes: {
    ...
    '#visual-archive .detail-media:nth-child(5) img': { alt: 'Laoshan folk-arts trifold brochure interior' },
    '#visual-archive .detail-media:nth-child(6) img': { alt: 'International Museum Day banner for Wuhan Museum' },
  ...
  copy: {
    ...
    '#visual-archive .detail-media:nth-child(5) figcaption': 'Laoshan Folk Arts · Trifold Interior',
    '#visual-archive .detail-media:nth-child(6) figcaption': 'International Museum Day · Wuhan Museum',
    ...
    '#edu .edu-entry:nth-child(1) .edu-dates': 'Aug 2023 — May 2027',
...
const zh = {
  ...
  attributes: {
    ...
    '#visual-archive .detail-media:nth-child(5) img': { alt: '崂山民艺文化三折页内页' },
    '#visual-archive .detail-media:nth-child(6) img': { alt: '武汉博物馆国际博物馆日活动 Banner' },
  ...
  copy: {
    ...
    '#visual-archive .detail-media:nth-child(5) figcaption': '崂山民艺 · 三折页内页',
    '#visual-archive .detail-media:nth-child(6) figcaption': '国际博物馆日 · 武汉博物馆',
    ...
    '#edu .edu-entry:nth-child(1) .edu-dates': '2023.08 — 2027.05',
