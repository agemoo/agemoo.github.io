...
test('second-layer route copy and attributes are selector-scoped and complete', () => {
  const copyRoots = {
    ...
    visual: [
      ...
      '#visual-archive h2',
      ...Array.from({ length: 6 }, (_, index) => `#visual-archive .detail-media:nth-child(${index + 1}) figcaption`),
  ...
  const attributeSelectors = [
    ...
    ...Array.from({ length: 6 }, (_, index) => `#visual-archive .detail-media:nth-child(${index + 1}) img`),
