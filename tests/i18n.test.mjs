...
test('second-layer route copy and attributes are selector-scoped and complete', () => {
  const copyRoots = {
    ...
    visual: [
      ...
      ...Array.from({ length: 9 }, (_, index) => `#visual-gallery .detail-media:nth-child(${index + 1}) figcaption`),
  ...
  const attributeSelectors = [
    ...
    ...Array.from({ length: 9 }, (_, index) => `#visual-gallery .detail-media:nth-child(${index + 1}) img`),
